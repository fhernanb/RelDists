...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/fhernanb/RelDists?branch=master&svg=true)](https://ci.appveyor.com/project/fhernanb/RelDists)
