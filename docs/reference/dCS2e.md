...
hazard function for the Cosine Sine Exponential distribution with
...
`dCS2e` gives the density, `pCS2e` gives the distribution function,
`qCS2e` gives the quantile function, `rCS2e` generates random deviates
and `hCS2e` gives the hazard function.
...
[CS2e](http://fhernanb.github.io/RelDists/reference/CS2e.md)
