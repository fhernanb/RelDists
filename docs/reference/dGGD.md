...
hazard function for the generalized Gompertz distribution with
...
`dGGD` gives the density, `pGGD` gives the distribution function, `qGGD`
gives the quantile function, `rGGD` generates random deviates and `hGGD`
...
[GGD](http://fhernanb.github.io/RelDists/reference/GGD.md)
