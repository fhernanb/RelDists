...
hazard function for the generalized modified weibull distribution with
...
`dGMW` gives the density, `pGMW` gives the distribution function, `qGMW`
gives the quantile function, `rGMW` generates random deviates and `hGMW`
gives the hazard function.

## Details

The generalized modified weibull with parameters `mu`, `sigma`, `nu` and
...
[GMW](http://fhernanb.github.io/RelDists/reference/GMW.md)
