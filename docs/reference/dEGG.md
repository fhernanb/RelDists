...
hazard function for the four parameter Exponentiated Generalized Gamma
...
`dEGG` gives the density, `pEGG` gives the distribution function, `qEGG`
gives the quantile function, `rEGG` generates random deviates and `hEGG`
...
[EGG](http://fhernanb.github.io/RelDists/reference/EGG.md)
