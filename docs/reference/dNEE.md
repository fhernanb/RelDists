...
hazard function for the two-parameter New Exponentiated Exponential with
...
`dNEE` gives the density, `pNEE` gives the distribution function, `qNEE`
gives the quantile function, `rNEE` generates random deviates and `hNEE`
...
[NEE](http://fhernanb.github.io/RelDists/reference/NEE.md)
