...
hazard function for the Beta Generalized Exponentiated distribution with
...
`dBGE` gives the density, `pBGE` gives the distribution function, `qBGE`
gives the quantile function, `rBGE` generates random deviates and `hBGE`
...
[BGE](http://fhernanb.github.io/RelDists/reference/BGE.md)
